...
// Speaker/Volume icon - for TTS
export const SpeakerIcon: React.FC<IconProps> = ({ size = 18, className = '', strokeWidth = 2 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" className={className} style={iconBaseStyle}>
...
// Speaker Off icon - for muted/stopped TTS
export const SpeakerOffIcon: React.FC<IconProps> = ({ size = 18, className = '', strokeWidth = 2 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" className={className} style={iconBaseStyle}>
    <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5" />
